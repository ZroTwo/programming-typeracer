            ...
            <div class="container-fluid flex flex-wrap justify-between items-center mx-3">
                ...
                <div class="hidden justify-between items-center w-full md:flex md:w-auto md:order-1" id="mobile-menu-2">
                    <ul class="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium">
                        <li>
                            <a href="#" class="block py-2 pr-4 pl-3 text-white bg-blue-700 rounded md:bg-transparent md:text-gray-400 md:p-0 dark:text-gray-400 hover:text-white hover:border-1 hover:bg-gradient-to-r from-indigo-700 via-purple-700 to-pink-700 hover:p-1 hover:rounded" aria-current="page">HTML</a>
                        </li>
                        <li>
                            <a href="#" class="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700 hover:text-white hover:border-1 hover:bg-gradient-to-r from-indigo-700 via-purple-700 to-pink-700 hover:p-1 hover:rounded">CSS</a>
                        </li>
                        <li>
                            <a href="#" class="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700 hover:text-white hover:border-1 hover:bg-gradient-to-r from-indigo-700 via-purple-700 to-pink-700 hover:p-1 hover:rounded">JavaScript</a>
                        </li>
                        <li>
                            <a href="#" class="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700 hover:text-white hover:border-1 hover:bg-gradient-to-r from-indigo-700 via-purple-700 to-pink-700 hover:p-1 hover:rounded">PHP</a>
                        </li>
                    </ul>
                </div>
            </div>
